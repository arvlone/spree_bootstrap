...
feature "Visiting products" do
  ...
  scenario "should be able to show the shopping cart after adding a product to it" do
  ...
  context "using Russian Rubles as a currency" do
    ...
    context "uses руб as the currency symbol" do
      ...
      scenario "when adding a product to the cart" do
        visit spree.product_path(product)
      ...
      scenario "when on the 'address' state of the cart" do
        visit spree.product_path(product)
        click_button "Add To Cart"
  ...
  scenario "should be able to search for a product" do
  ...
  context "a product with variants" do
    given(:product) { Spree::Product.find_by_name("Ruby on Rails Baseball Jersey") }
  ...
  scenario "should be able to hide products without price" do
  ...
  scenario "should be able to display products priced under 10 dollars" do
  ...
  scenario "should be able to display products priced between 15 and 18 dollars" do
    within(:css, "#taxonomies") { click_link "Ruby on Rails" }
  ...
  scenario "should be able to display products priced between 15 and 18 dollars across multiple pages" do
  ...
  scenario "should be able to display products priced 18 dollars and above" do
    within(:css, "#taxonomies") { click_link "Ruby on Rails" }
  ...
  scenario "should be able to put a product without a description in the cart" do
  ...
  scenario "shouldn't be able to put a product without a current price in the cart" do
    product = FactoryGirl.create(:base_product, description: nil, name: "Sample", price: "19.99")
    Spree::Config.currency = "CAN"
